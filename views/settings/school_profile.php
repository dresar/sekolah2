...
<script type="text/javascript">
      ...
      fields: [
         {
            ...
            renderer:function(row) {
               ...
               if (row.variable == 'headmaster_photo') {
                  return UPLOAD(_form23 + '.OnUpload(' + row.id + ')', 'image', 'Upload Photo ' + (_SCHOOL_LEVEL == 5 ? 'Rektor' : (_SCHOOL_LEVEL == 6 ? 'Ketua' : (_SCHOOL_LEVEL == 7 ? 'Direktur' : 'Kepala Sekolah'))));
               }
            },
            exclude_excel : true,
            sorting: false
         ...
         },
         {
            ...
            renderer: function( row ) {
               ...
               if (row.variable == 'headmaster') {
                  return (_SCHOOL_LEVEL == 5 ? 'Rektor' : (_SCHOOL_LEVEL == 6 ? 'Ketua' : (_SCHOOL_LEVEL == 7 ? 'Direktur' : 'Kepala Sekolah')));
               }
               if (row.variable == 'headmaster_photo') {
                  return 'Photo' + (_SCHOOL_LEVEL == 5 ? 'Rektor' : (_SCHOOL_LEVEL == 6 ? 'Ketua' : (_SCHOOL_LEVEL == 7 ? 'Direktur' : 'Kepala Sekolah')));
               }
   ...
   */
   new FormBuilder( _form22, {
      controller:'settings/school_profile',
      fields: [
         { label:'Nama ' + (_SCHOOL_LEVEL == 5 ? 'Rektor' : (_SCHOOL_LEVEL == 6 ? 'Ketua' : (_SCHOOL_LEVEL == 7 ? 'Direktur' : 'Kepala Sekolah'))), name:'value' }
      ]
   });
   ...
   */
   new FormBuilder( _form23, {
      controller:'settings/school_profile',
      fields: [
         { label:'Photo ' + (_SCHOOL_LEVEL == 5 ? 'Rektor' : (_SCHOOL_LEVEL == 6 ? 'Ketua' : (_SCHOOL_LEVEL == 7 ? 'Direktur' : 'Kepala Sekolah'))), name:'value' }
      ]
   });
