		...
		<div class="tab-content">
			<div role="tabpanel" class="tab-pane active" id="tab_1">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<?=form_dropdown('first_choice', $majors, set_value('first_choice'), 'class="form-control input-sm" id="first_choice" onchange="check_options(1)" onblur="check_options(1)" onmouseup="check_options(1)"')?>
					</div>
				</div>
				<div class="form-group">
					<label for="second_choice" class="col-sm-4 control-label">Pilihan II (Dua) <span style="color: red">*</span></label>
					<div class="col-sm-8">
						<?=form_dropdown('second_choice', $majors, set_value('second_choice'), 'class="form-control input-sm" id="second_choice" onchange="check_options(2)" onblur="check_options(2)" onmouseup="check_options(2)"')?>
					</div>
				</div>
				<?php } ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" value="<?php echo set_value('diploma_number')?>" class="form-control input-sm" id="diploma_number" name="diploma_number" placeholder="Nomor Seri Ijazah Sebelumnya">
					</div>
				</div>
				<?php } ?>
				<div class="form-group">
			...
			<div role="tabpanel" class="tab-pane" id="tab_2">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" value="<?php echo set_value('nik')?>" class="form-control input-sm" id="nik" name="nik" placeholder="Nomor Induk Kependudukan">
					</div>
				</div>
				<?php } ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<div class="input-group">
							<input  type="text" readonly="true" value="<?php echo set_value('birth_date')?>" class="form-control input-sm" id="birth_date" name="birth_date">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<?=form_dropdown('religion', $religion, set_value('religion'), 'class="form-control input-sm" id="religion"')?>
					</div>
				</div>
				<div class="form-group">
					<label for="special_needs" class="col-sm-4 control-label">Kebutuhan Khusus</label>
					<div class="col-sm-8">
						<?=form_dropdown('special_needs', $special_needs, set_value('special_needs'), 'class="form-control input-sm" id="special_needs"')?>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<?=form_dropdown('residence', $residence, set_value('residence'), 'class="form-control input-sm" id="residence"')?>
					</div>
				</div>
				<div class="form-group">
					<label for="transportation" class="col-sm-4 control-label">Moda Transportasi</label>
					<div class="col-sm-8">
						<?=form_dropdown('transportation', $transportation, set_value('transportation'), 'class="form-control input-sm" id="transportation"')?>
					</div>
				</div>
				<div class="form-group">
			...
			<div role="tabpanel" class="tab-pane" id="tab_3">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<?=form_dropdown('father_education', $education, set_value('father_education'), 'class="form-control input-sm" id="father_education"')?>
					</div>
				</div>
				<div class="form-group">
					<label for="father_employment" class="col-sm-4 control-label">Pekerjaan</label>
					<div class="col-sm-8">
						<?=form_dropdown('father_employment', $employment, set_value('father_employment'), 'class="form-control input-sm" id="father_employment"')?>
					</div>
				</div>
				<div class="form-group">
					<label for="father_monthly_income" class="col-sm-4 control-label">Penghasilan Bulanan</label>
					<div class="col-sm-8">
						<?=form_dropdown('father_monthly_income', $monthly_income, set_value('father_monthly_income'), 'class="form-control input-sm" id="father_monthly_income"')?>
					</div>
				</div>
				<div class="form-group">
					<label for="father_special_needs" class="col-sm-4 control-label">Kebutuhan Khusus</label>
					<div class="col-sm-8">
						<?=form_dropdown('father_special_needs', $special_needs, set_value('father_special_needs'), 'class="form-control input-sm" id="father_special_needs"')?>
					</div>
				</div>
			</div>
			<div role="tabpanel" class="tab-pane" id="tab_4">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<?=form_dropdown('mother_education', $education, set_value('mother_education'), 'class="form-control input-sm" id="mother_education"')?>
					</div>
				</div>
				<div class="form-group">
					<label for="mother_employment" class="col-sm-4 control-label">Pekerjaan</label>
					<div class="col-sm-8">
						<?=form_dropdown('mother_employment', $employment, set_value('mother_employment'), 'class="form-control input-sm" id="mother_employment"')?>
					</div>
				</div>
				<div class="form-group">
					<label for="mother_monthly_income" class="col-sm-4 control-label">Penghasilan Bulanan</label>
					<div class="col-sm-8">
						<?=form_dropdown('mother_monthly_income', $monthly_income, set_value('mother_monthly_income'), 'class="form-control input-sm" id="mother_monthly_income"')?>
					</div>
				</div>
				<div class="form-group">
					<label for="mother_special_needs" class="col-sm-4 control-label">Kebutuhan Khusus</label>
					<div class="col-sm-8">
						<?=form_dropdown('mother_special_needs', $special_needs, set_value('mother_special_needs'), 'class="form-control input-sm" id="mother_special_needs"')?>
					</div>
				</div>
			</div>
			<div role="tabpanel" class="tab-pane" id="tab_5">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<?=form_dropdown('guardian_education', $education, set_value('guardian_education'), 'class="form-control input-sm" id="guardian_education"')?>
					</div>
				</div>
				<div class="form-group">
					<label for="guardian_employment" class="col-sm-4 control-label">Pekerjaan</label>
					<div class="col-sm-8">
						<?=form_dropdown('guardian_employment', $employment, set_value('guardian_employment'), 'class="form-control input-sm" id="guardian_employment"')?>
					</div>
				</div>
				<div class="form-group">
					<label for="guardian_monthly_income" class="col-sm-4 control-label">Penghasilan Bulanan</label>
					<div class="col-sm-8">
						<?=form_dropdown('guardian_monthly_income', $monthly_income, set_value('guardian_monthly_income'), 'class="form-control input-sm" id="guardian_monthly_income"')?>
					</div>
				</div>
			</div>
