		...
		<div class="panel-body">
			<form class="form-horizontal">
				<div class="box-body">
                  ...
                  <label for="academic_year_id" class="col-sm-3 control-label"><?=call_academic_year(get_school_level());?></label>
                  <div class="col-sm-9">
               ...
               <div class="form-group">
                  <label for="students" class="col-sm-3 control-label"><?=call_student_name(get_school_level());?></label>
                  <div class="col-sm-9">
