			...
			<div class="box box-success box-solid collapsed-box">
				...
				<form role="form">
					...
					<div class="box-footer">
						<button type="submit" onclick="save_links(); return false;" class="btn btn-sm btn-primary pull-right"><i class="fa fa-send"></i> SIMPAN</button>
					</div>
				</form>
			</div>
			<div class="box box-success box-solid collapsed-box">
			...
			<div class="box box-success box-solid collapsed-box">
				...
				<div class="box-footer">
					<div class="row">
						...
						<div class="col-md-6">
							<button onclick="save_modules()" type="submit" class="btn btn-sm btn-primary pull-right"><i class="fa fa-send"></i> SIMPAN</button>
						</div>
					</div>
				</div>
			</div>
