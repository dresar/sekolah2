				...
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<?php } ?>
							Copyright &copy; 2018 - <?=date('Y');?> media utama All Rights Reserved<br>
							Powered by <a href="http://www.penelitianku.com">media utama</a> &sdot; Back to <a href="<?=base_url()?>"><?=$this->session->userdata('school_name')?></a></p>
						</div>
					</div>
				</div>
			</div>
