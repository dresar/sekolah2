...
<script type="text/javascript">
	...
	new GridBuilder( _grid , {
        ...
        fields: [
            ...
            { header:'Kegiatan', renderer:'quote_by' },
    		{ header:'Deskripsi', renderer:'quote' },
            { header:'Icon', renderer:'status' },
    ...
    new FormBuilder( _form , {
	    controller:'blog/quotes',
	    fields: [
            { label:'Kegiatan', name:'quote_by' },
            { label:'Deskripsi', name:'quote', type:'textarea' },
