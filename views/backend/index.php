...
<head>
	...
	<meta name="author" content="Media Utama, syaifulpb11@gmail.com">
	<meta name="designer" content="Media Utama, syaifulpb11@gmail.com">
	<meta name="reply-to" content="syaifulpb11@gmail.com">
	<meta name="owner" content="Media Utama">
	<meta name="url" content="http://www.penelitianku.com">
	<meta name="identifier-URL" content="http://www.penelitianku.com">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>CMS (Content Management System) dan PPDB Online PREMIUM untuk sekolah SD, SMP/Sederajat, SMA/Sederajat, dan Perguruan Tinggi.</p>
					<table class="table table-condensed table-bordered">
						<tbody>
							...
							<tr>
								<td>Author</td>
								<td>:</td>
								<td><a href="http://www.penelitianku.com">Mediautama</a></td>
							</tr>
							<tr>
								<td>Email</td>
								<td>:</td>
								<td>syaifulpb11@gmail.com</td>
							</tr>
							<tr>
								<td>CMS Version</td>
								<td>:</td>
					...
					<ol>
						<li>Website Premium Theme Academics</li>
					</ol>
				</div>
			</div>
		</div>
