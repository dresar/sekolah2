...
<section class="sidebar">
	<ul class="sidebar-menu">
		...
		<?php if ($this->session->userdata('user_type') === 'student' && in_array('student_profile', $this->session->userdata('user_privileges'))) { ?>
			...
			<li class="<?=isset($nilaicbt) ? 'active':'';?>">
				<a href="<?=site_url('nilaicbt');?>">
					<i class="fa fa-trophy"></i> <span>Nilai USBK</span>
				</a>
			</li>
		<?php } ?>
		...
		<?php if ($this->session->userdata('user_type') === 'super_user' || $this->session->userdata('user_type') === 'administrator') { ?>
			...
			<li class="treeview <?=isset($blog) ? 'active':'';?>">
				...
				<ul class="treeview-menu">
					...
					<li <?=isset($quotes) ? 'class="active"':'';?>><a href="<?=site_url('blog/quotes');?>"><i class="fa fa-desktop"></i> Service</a></li>
					<li <?=isset($testimoni) ? 'class="active"':'';?>><a href="<?=site_url('blog/testimoni');?>"><i class="fa fa-quote-right"></i> Testimoni</a></li>
					<li <?=isset($agenda) ? 'class="active"':'';?>><a href="<?=site_url('blog/agenda');?>"><i class="fa fa-list"></i> Agenda</a></li>
					<li <?=isset($headmaster) ? 'class="active"':'';?>><a href="<?=site_url('blog/headmaster');?>"><i class="fa fa-users"></i> Headmaster</a></li>
					<li <?=isset($welcome) ? 'class="active"':'';?>><a href="<?=site_url('blog/welcome');?>"><i class="fa fa-bullhorn"></i> Sambutan <?=call_headmaster(get_school_level());?></a></li>
		...
		<?php if ($this->session->userdata('user_type') === 'super_user' || $this->session->userdata('user_type') === 'administrator') { ?>
			...
			<li class="treeview <?=isset($reference) ? 'active':'';?>">
				<a href="#">
					<i class="fa fa-sign-out"></i> <span>Data Referensi</span> <i class="fa fa-angle-left pull-right"></i>
				</a>
				<ul class="treeview-menu">
					...
					<li <?=isset($academic_years) ? 'class="active"':'';?>><a href="<?=site_url('reference/academic_years');?>"><i class="fa fa-sign-out"></i> Tahun Akademik</a></li>
				</ul>
			</li>
			<?php } ?>
		<?php } ?>
		...
		<?php if ($this->session->userdata('user_type') === 'super_user' || $this->session->userdata('user_type') === 'administrator') { ?>
			...
			<li class="treeview <?=isset($students) ? 'active':'';?>">
				<a href="#">
					<i class="fa fa-user-plus"></i> <span><?=call_student_name(get_school_level());?> </span> <i class="fa fa-angle-left pull-right"></i>
				</a>
				<ul class="treeview-menu">
					...
					<li <?=isset($student_reference) ? 'class="active"':'';?>>
						<a href="#"><i class="fa fa-sign-out"></i> Data Referensi <i class="fa fa-angle-left pull-right"></i></a>
						<ul class="treeview-menu">
							<li <?=isset($class_groups) ? 'class="active"':'';?>><a href="<?=site_url('students/class_groups');?>"><i class="fa fa-sign-out"></i> Kelas</a></li>
							<li <?=isset($transportations) ? 'class="active"':'';?>><a href="<?=site_url('students/transportations');?>"><i class="fa fa-sign-out"></i> Moda Transportasi</a></li>
							<li <?=isset($educations) ? 'class="active"':'';?>><a href="<?=site_url('students/educations');?>"><i class="fa fa-sign-out"></i> Pendidikan</a></li>
							<li <?=isset($monthly_income) ? 'class="active"':'';?>><a href="<?=site_url('students/monthly_income');?>"><i class="fa fa-sign-out"></i> Penghasilan Orang Tua</a></li>
							<?php if (in_array(get_school_level(), have_majors())) { ?>
								<li <?=isset($majors) ? 'class="active"':'';?>><a href="<?=site_url('students/majors');?>"><i class="fa fa-sign-out"></i> Program Keahlian</a></li>
							<?php } ?>
							<li <?=isset($student_status) ? 'class="active"':'';?>><a href="<?=site_url('students/student_status');?>"><i class="fa fa-sign-out"></i> Status <?=call_student_name(get_school_level());?></a></li>
							<li <?=isset($residence) ? 'class="active"':'';?>><a href="<?=site_url('students/residence');?>"><i class="fa fa-sign-out"></i> Tempat Tinggal</a></li>
						</ul>
					</li>
					<li <?=isset($chart_students) ? 'class="active"':'';?>><a href="<?=site_url('students/chart');?>"><i class="fa fa-bar-chart"></i> Grafik</a></li>
					<li <?=isset($import_alumni) ? 'class="active"':'';?>><a href="<?=site_url('students/import_alumni');?>"><i class="fa fa-upload"></i> Import Alumni</a></li>
					<li <?=isset($import_students) ? 'class="active"':'';?>><a href="<?=site_url('students/import_students');?>"><i class="fa fa-upload"></i> Import <?=call_student_name(get_school_level());?></a></li>
					...
					<li <?=isset($all_students) ? 'class="active"':'';?>><a href="<?=site_url('students/students');?>"><i class="fa fa-smile-o"></i> Semua <?=call_student_name(get_school_level());?></a></li>
				</ul>
			</li>
			<?php } ?>
		<?php } ?>
			...
			<li class="treeview <?=isset($employees) ? 'active':'';?>">
				...
				<ul class="treeview-menu">
					<li <?=isset($employee_reference) ? 'class="active"':'';?>>
						<a href="#"><i class="fa fa-sign-out"></i> Data Referensi <i class="fa fa-angle-left pull-right"></i></a>
						<ul class="treeview-menu">
							<li <?=isset($employment_types) ? 'class="active"':'';?>><a href="<?=site_url('employees/employment_types');?>"><i class="fa fa-sign-out"></i> Jenis <?=call_employee_name(get_school_level());?></a></li>
							<li <?=isset($skills_laboratory) ? 'class="active"':'';?>><a href="<?=site_url('employees/skills_laboratory');?>"><i class="fa fa-sign-out"></i> Keahlian Laboratorium</a></li>
							<li <?=isset($institutions_lifter) ? 'class="active"':'';?>><a href="<?=site_url('employees/institutions_lifter');?>"><i class="fa fa-sign-out"></i> Lembaga Pengangkat</a></li>
							<li <?=isset($ranks) ? 'class="active"':'';?>><a href="<?=site_url('employees/ranks');?>"><i class="fa fa-sign-out"></i> Pangkat / Golongan</a></li>
							<li <?=isset($employment) ? 'class="active"':'';?>><a href="<?=site_url('employees/employment');?>"><i class="fa fa-sign-out"></i> Pekerjaan Suami / Istri</a></li>
					...
					<li <?=isset($import_employees) ? 'class="active"':'';?>><a href="<?=site_url('employees/import');?>"><i class="fa fa-upload"></i> Import <?=call_employee_name(get_school_level());?></a></li>
					<li <?=isset($all_employees) ? 'class="active"':'';?>><a href="<?=site_url('employees/employees');?>"><i class="fa fa-smile-o"></i> Semua <?=call_employee_name(get_school_level());?></a></li>
				</ul>
			</li>
			<?php } ?>
		<?php } ?>
		...
		<?php if ($this->session->userdata('user_type') === 'super_user' || $this->session->userdata('user_type') === 'administrator') { ?>
			...
			<li class="treeview <?=isset($acl) ? 'active':'';?>">
				...
				<ul class="treeview-menu">
					...
					<?php } ?>
					<li <?=isset($user_students) ? 'class="active"':'';?>><a href="<?=site_url('acl/students');?>"><i class="fa fa-smile-o"></i> <?=call_student_name(get_school_level());?></a></li>
					<li <?=isset($user_employees) ? 'class="active"':'';?>><a href="<?=site_url('acl/employees');?>"><i class="fa fa-smile-o"></i> <?=call_employee_name(get_school_level());?></a></li>
