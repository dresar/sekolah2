...
class Agenda extends Admin_Controller {
	...
	public function index() {
		$this->vars['title'] = 'AGENDA';
		$this->vars['blog'] = $this->vars['agenda'] = true;
		$this->vars['content'] = 'agenda/read';
	...
	public function pagination() {
		...
		$query = $this->m_agenda->get_where($keyword, $limit, $offset);
		$total_rows = $this->m_agenda->total_rows($keyword);
