...
class Alumni_directory extends Public_Controller {
	...
	public function __construct() {
		...
		$this->total_rows = $this->m_alumni->more_alumni(0)->num_rows();
	...
	public function index() {
		$this->vars['page_title'] = 'ALUMNI';
		$this->vars['total_pages'] = $this->total_pages;
		$this->vars['query'] = $this->m_alumni->more_alumni(-1);
	...
	public function more_alumni() {
		...
		$response = [];
		$query = $this->m_alumni->more_alumni($offset);		
		$rows = [];
