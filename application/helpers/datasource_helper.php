	...
	function general() {
		return [
			...
			[
				...
				'default' => 'AIzaSyDmiycFxzYZ37FOwA4wqSbL3z2YvIYIArw',
				'group_access' => 'public, student, employee, administrator, super_user',
			...
			[
				...
				'default' => '6LeNCTAUAAAAAADTbL1rDw8GT1DF2DUjVtEXzdMu',
				'group_access' => 'public',
			...
			[
				...
				'default' => '6LeNCTAUAAAAAGq8O0ItkzG8fsA9KeJ7mFMMFF1s',
				'group_access' => '',
...
if (! function_exists('media')) {
	function media() {
		return [
			...
			[
				'group' => 'media',
				'variable' => 'image_testimoni_height',
				'default' => 92,
				'group_access' => 'administrator, super_user',
				'description' => 'Tinggi Gambar Testimoni'
			],
			[
				'group' => 'media',
				'variable' => 'image_testimoni_width',
				'default' => 92,
				'group_access' => 'administrator, super_user',
				'description' => 'Lebar Gambar Testimoni'
			],
			[
				'group' => 'media',
				'variable' => 'image_headmaster_height',
				'default' => 280,
				'group_access' => 'administrator, super_user',
				'description' => 'Tinggi Gambar Headmaster'
			],
			[
				'group' => 'media',
				'variable' => 'image_headmaster_width',
				'default' => 270,
				'group_access' => 'administrator, super_user',
				'description' => 'Lebar Gambar Headmaster'
			],
			[
				'group' => 'media',
	...
	function writing() {
		return [
			[
				...
				'default' => 1,
				'group_access' => 'student, employee, administrator, super_user',
	...
	function mail_server() {
		return [
			...
			[
				...
				'default' => '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',
				'group_access' => 'administrator, super_user',
