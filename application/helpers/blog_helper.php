...
if (! function_exists('get_agenda')) {
	function get_agenda($limit) {
		$CI = &get_instance();
		$CI->load->model('m_agenda');
		return $CI->m_agenda->get_agenda($limit);
	}
}
 ...
 * Get Image Sliders
 */
if (! function_exists('get_testimoni')) {
	function get_testimoni() {
		$CI = &get_instance();
		$CI->load->model('m_testimoni');
		return $CI->m_testimoni->get_testimoni();
	}
}
 ...
 * Get Image Sliders
 */
if (! function_exists('get_headmaster')) {
	function get_headmaster() {
		$CI = &get_instance();
		$CI->load->model('m_headmaster');
		return $CI->m_headmaster->get_headmaster();
	}
}
